...
{
    const char* pszTimestamp = "Friday, 19 de January de 2018";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 5 * 60; // Cada 5 minutos
        consensus.nPowTargetSpacing = 15; // Cada 15 segundos
        ...
        genesis = CreateGenesisBlock(1516401284, 0, 0x1e0ffff0, 1, 50 * COIN);
